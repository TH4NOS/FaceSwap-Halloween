...
'''def sendEmail(filename):
    ...
    filename = "../data/image/completed/"+ filename
    ...
    sender = 'doubledecker.blr@gmail.com'
    reciever = 'britus2david@gmail.com'
    ...
    try:
       ...
       smtpObj.ehlo()
       smtpObj.starttls()
       smtpObj.login("doubledecker.blr@gmail.com", "Getmorph1!")  
